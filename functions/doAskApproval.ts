...
export const doAskApprovalFunction = DefineFunction({
    callback_id: "do_ask_approval",
    title: "Ask Manager Approval",
    description: "Ask approval to selected manager",
    source_file: "functions/doAskApproval.ts",
    input_parameters: {
        properties: {
            requester: {
...
export default SlackFunction(doAskApprovalFunction, async ({
    inputs,
    client,
    env
},) => {
